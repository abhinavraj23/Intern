    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        SignUp.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent SignUp = new Intent(LoginActivity1.this, SignUpActivity.class);
        ...
        Login.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent Login = new Intent(LoginActivity1.this, Home_Activity.class);
                startActivity(Login);
                finish();
            }
        });
        ...
        GoogleSignInOptions gso = new GoogleSignInOptions.Builder(GoogleSignInOptions.DEFAULT_SIGN_IN)
                ...
                .build();
        mGoogleBtn = (SignInButton) findViewById(R.id.googleBtn2);
        ...
        mAuthListner = new FirebaseAuth.AuthStateListener() {
            ...
            public void onAuthStateChanged(@NonNull FirebaseAuth firebaseAuth) {
                if (firebaseAuth.getCurrentUser() != null) {
                    Intent intent = new Intent(LoginActivity1.this, Home_Activity.class);
                                    ...
                                    if(!exists[0]) {
                                        ...
                                        userData.setValue(datamap).addOnCompleteListener(new OnCompleteListener<Void>() {
                                            ...
                                            public void onComplete(@NonNull Task<Void> task) {
                                                if(!task.isSuccessful()){
                                                    Toast.makeText(LoginActivity1.this,"Error occured", Toast.LENGTH_SHORT).show();
                                                }
                                            }
                                        });
                                    }
